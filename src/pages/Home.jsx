        ...
        <div class="container pt-5">
            <div className="row">
                <div className="col-sm-12 col-md-4">
                    <div class="card tarjeta-presentacion">
                        <div class="card-header mb-3">Información de contacto</div>
                        ...
                        <div class="card-body text-dark text-center">
                            ...
                            <p class="card-text">Ingeniero en mecatrónica</p>
                        </div>
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item cursor-pointer" onclick="javascript:window.open('mailto:joelmp3@live.com','_blank')">
                            ...
                            <li class="list-group-item cursor-pointer" onclick="javascript:window.open('https://github.com/Davel99','_blank')">
